...
export default function PokemonDetail() {
  ...
  return (
    <section>
      <figure className="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-screen hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
        <img
          src={pokemon?.sprites?.other["official-artwork"]?.front_default}
          alt=""
          className="object-cover w-full rounded-t-lg md:h-auto md:w-96 md:rounded-none md:rounded-l-lg"
        />
          ...
          <ul className="space-y-3">
            <li>
              ...
              >
                ...
                {/* <p>{pokemon?.abilities?.[0]["ability"]?.generation.name}</p> */}
            ...
            <li>
              ...
              >
                <span className="flex-1 ml-3 whitespace-nowrap ">
                  <p className="text-white">Movimiento:</p>
            ...
            <li>
              ...
              >
                <span className="flex-1 ml-3 whitespace-nowrap">
                  <p className="text-white">Especie:</p>
                  <button className="relative inline-flex items-center justify-center p-0.5 mb-2 mr-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-pink-500 to-orange-400 group-hover:from-pink-500 group-hover:to-orange-400 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800">
                    <span className="relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0">
      ...
      <button className="relative inline-flex items-center justify-center p-0.5 mb-2 mr-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-purple-500 to-pink-500 group-hover:from-purple-500 group-hover:to-pink-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800">
        <span className="relative px-36 py-2.5 text-2xl transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0">
